...
class Api extends \Opencart\System\Engine\Controller {
    ...
    public function index(): ?\Opencart\System\Engine\Action {
        ...
        // Allow access without API key, IP check, and signature for testing
        ...
        if (in_array($route, $allowed)) {
            ...
            // Skip parameter checks for testing (optional)
            // $required = [
            //     'route',
            //     'call',
            //     'username',
            ...
            // If no API parameters are missing, proceed (skip IP and signature checks)
            if ($status) {
                // Commenting out signature and IP checks
                // $this->load->model('user/api');
                // $api_info = $this->model_user_api->getApiByUsername((string)$this->request->get['username']);

                // if ($api_info) {
                //     // Skip IP check for testing
                //     $ip_data = [];
